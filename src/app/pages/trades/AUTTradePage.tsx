...
const AUTTradePage: React.FC<AUTTradePageProps> = ({ onNavigate }) => {
  ...
  const stats = [
    { label: 'Active Students', value: students.length, icon: Users, color: 'from-green-500 to-teal-500' },
    { label: 'Expert Teachers', value: teachers.length, icon: GraduationCap, color: 'from-cyan-500 to-blue-500' },
                    ...
                    >
                      <Card className="border-2 border-green-200 hover:shadow-xl transition-all overflow-hidden">
                        ...
                        <CardContent className="p-6">
                          ...
                          <p className="text-sm text-green-600 font-bold mb-3">{teacher.specialization}</p>
