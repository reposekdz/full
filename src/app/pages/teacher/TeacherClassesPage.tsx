            ...
            <Card key={index} className="border-2 border-yellow-200 hover:shadow-xl transition-all">
              <CardContent className="p-6">
                <div className="p-4 rounded-xl bg-gradient-to-br from-yellow-500 to-green-500 mb-4">
                  <h3 className="text-lg font-black text-white">{cls.class_name} - {cls.course_name}</h3>
                </div>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-green-100 text-green-700">{Math.round(cls.attendance_rate || 0)}%</Badge>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Impera:</span>
                    <Badge className="bg-blue-100 text-blue-700">{Math.round(cls.average_grade || 0)}%</Badge>
                  </div>
                </div>
