...
export declare const randomColor: () => "#e91e63" | "#2196f3" | "#ff9800" | "#f44336" | "#4caf50" | "#03a9f4" | "#9c27b0";
...
export declare const randomCountry: () => import("./static-data.js").CountryIsoOption;
