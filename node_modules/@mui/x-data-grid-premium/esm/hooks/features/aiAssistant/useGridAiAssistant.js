...
export const useGridAiAssistant = (apiRef, props) => {
  ...
  const preferencePanelPreProcessing = React.useCallback((initialValue, value) => {
    if (isAiAssistantAvailable && slots.aiAssistantPanel && value === GridPreferencePanelsValue.aiAssistant) {
      return /*#__PURE__*/_jsx(slots.aiAssistantPanel, {});
    }
    return initialValue;
  ...
  const setConversationPrompts = React.useCallback((index, callback) => {
    ...
    const newConversations = currentConversations.toSpliced(targetConversation === undefined ? currentConversations.length : index, 1, _extends({}, targetConversation, {
