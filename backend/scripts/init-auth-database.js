...
async function initializeDatabase() {
  ...
  try {
    ...
    `);
    console.log('✅ Parent-Student linking table created');
    ...
    `);
    console.log('✅ Academic years table created');
    ...
    `);
    console.log('✅ Trade levels table created');
    ...
    `);
    console.log('✅ Default trade levels inserted');

    // Create trade_classes table
    await connection.execute(`
    ...
    `);
    console.log('✅ Trade classes table created');
    ...
    // Create student_performance_summary table
    await connection.execute(`
    ...
    `);
    console.log('✅ Student performance summary table created');
    ...
    await connection.execute(`
      ...
      ('admin', 'admin@gardentvet.com', ?, 'System', 'Admin', 'super_admin')
    `, [adminPassword]);
    ...
    if (studentRole.length > 0) {
      ...
      await connection.execute(`
        INSERT IGNORE INTO users (
          ...
          phone, role_id, student_id, is_active
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, true)
      `, [
        'demo_student',
        'student@gardentvet.com',
        studentPassword,
        'Demo',
        'Student',
        '0788123456',
      ...
      console.log('✅ Demo student created (email: student@gardentvet.com, password: student123)');
    }
    ...
    if (parentRole.length > 0) {
      ...
      console.log('✅ Demo parent created (phone: 0788654321, password: parent123)');
    }
    ...
    console.log('   Admin:   admin@gardentvet.com / admin123');
    console.log('   Student: student@gardentvet.com / student123');
    console.log('   Parent:  0788654321 / parent123');
