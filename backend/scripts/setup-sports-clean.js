...
async function setupSports() {
  ...
  try {
    ...
    await connection.query('DROP TABLE IF EXISTS sports_players');
    await connection.query('DROP TABLE IF EXISTS sports_coaches');
    ...
    const footballPlayers = [
      [1, 'Mugisha Eric', 'Mugisha Eric', 1, 'Goalkeeper', 'Umurinzi Urubuga', '/uploads/sports/player-f1.jpg', '2005-03-15', 180, 75, 'Level 4A', true, '2023-01-10'],
