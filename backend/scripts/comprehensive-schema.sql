-- Comprehensive School Management System Database Schema
-- This schema includes all tables needed for the complete system
...
-- Content Management Tables (existing)
...
-- Default courses (based on the existing trades)
...
-- Insert default content data from existing schema
