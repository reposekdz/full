  ...
  try {
    ...
    await connection.execute(`
      INSERT INTO global_student_sheets (
        student_id, student_code, username, first_name, last_name, email, phone,
        trade_code, trade_name, level_number, status
      )
      SELECT 
        u.id,
        COALESCE(u.student_code, u.student_id, CONCAT('STD', LPAD(u.id, 6, '0'))),
        u.username,
        u.first_name,
        u.last_name,
        u.email,
    ...
    console.log('✓ Backend Route: Accessible to all authenticated staff');
