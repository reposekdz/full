-- ═══════════════════════════════════════════════════════════════════════════
-- PARENT-CHILD LINKING SYSTEM - COLLATION FIXED MIGRATION
-- ═══════════════════════════════════════════════════════════════════════════
...
LEFT JOIN global_student_sheets gss ON 
  gss.first_name COLLATE utf8mb4_general_ci = pla.child_first_name AND
  gss.last_name COLLATE utf8mb4_general_ci = pla.child_last_name AND
  gss.gender COLLATE utf8mb4_general_ci = pla.child_gender AND
  gss.trade_code COLLATE utf8mb4_general_ci = pla.child_trade_code AND
