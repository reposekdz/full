// ═══════════════════════════════════════════════════════════════════════════
// PARENT LINKING TABLES - SIMPLE SETUP SCRIPT
// ═══════════════════════════════════════════════════════════════════════════
...
async function runSetup() {
  ...
  try {
    ...
    `);
    console.log('   ✅ parent_linking_applications');
    ...
    `);
    console.log('   ✅ parent_child_links');
    ...
    `);
    console.log('   ✅ parent_linking_audit_log\n');
    ...
    await connection.query(`
      ...
      END
    `);
    console.log('   ✅ sp_submit_parent_linking_application');

    await connection.query('DROP PROCEDURE IF EXISTS sp_approve_parent_linking_application');
    await connection.query(`
      ...
      END
    `);
    console.log('   ✅ sp_approve_parent_linking_application');

    await connection.query('DROP PROCEDURE IF EXISTS sp_reject_parent_linking_application');
    await connection.query(`
      ...
      END
    `);
    console.log('   ✅ sp_reject_parent_linking_application\n');
